export const quizData = {
  ...
  questions: [
    {
      question: "Who was the first person to use the word 'atom'?",
      options: ['JJ Thompson', 'Democritus', 'Niels Bohr', 'Ewin Schrodinger'],
      answer: 'Democritus'
    },
    {
      question: 'Whose theory is called the theory of the universe?',
      options: ['Democritus', 'Niels Bohr', 'Ewin Schrodinger', 'None of the above'],
      answer: "Democritus"
    },
    {
      question: 'All but one are assumptions of Democritus.',
    ...
    {
      question: 'The probability of finding the electrons in the orbitals is referred to as ______',
      options: ['Electron path way', 'Probability', 'Lobes', 'Projectile'],
      answer: 'Lobes'
    },
    {
      question: 'Ewin Schrodinger used the _____ principle to come up with the atomic model that we still use today',
    ...
    {
      question: '_____ is the process they leads to the transformation of one set of chemical substance to another',
      options: ['Chemical reaction', 'Chemical equilibrium', 'Chemical equation', 'Chemical Intermediate'],
      answer: 'Chemical reaction'
    },
    {
      question: 'In chemical reaction only the position of the _____ is involved in the formation and breaking of chemical bonds between atoms.',
      options: ["Proton", "Electron", "Neutron", "Nucleus"],
      answer: 'Electron',
    },
    {
      question: '_____ are used to describe chemical reaction.',
      options: ['Chemical symbols', 'Chemical equation', 'Chemical intermediate', 'Reacting species'],
      answer: 'Chemical equation'
    },
    {
      question: 'The beginning ingredients of a chemical reaction are referred to as _____',
      options: ['Reactant', "Product", "Water", "Indicator"],
      answer: 'Reactant'
    },
    {
      question: 'Coefficients are added in front of the chemical formulas to show the number of _____ of the material consumed or created. ',
      options: ['Molecules', "Atoms", "Radicals", "Electrons"],
      answer: 'Molecules'
    },
    {
      question: "Consider the reaction.\n\n<div style='font-size: 18px'>AH<sub>2</sub> + BO<sub>2</sub> → CH<sub>2</sub>O</div>\nWhat is A in the above equation?",
      options: ['1', '2', '0', '4'],
      answer: '2'
    },
    {
      question: "Consider the reaction.\n\n<div style='font-size: 18px'>AH<sub>2</sub> + BO<sub>2</sub> → CH<sub>2</sub>O</div>\nWhat is B in the above equation?",
      options: ['1', '2', '0', '4'],
      answer: '1'
    },
    {
    ...
    {
      question: '↔ represent ____ in a chemical equation',
    ...
    {
      question: '____ is the study of the measurements of units of matter( atom, ion, molecules e.t.c) in chemical formulas and reaction.',
    ...
    {
      question: 'Who was able to answer why electrons did not collapse into the nucleus?',
      options: ['William Thomson', 'Niels Bohr', 'Ewin Schrodinger', 'Rutherford'],
      answer: 'Niels Bohr'
    },
    {
      question: 'Whose atomic model is known as the Plum pudding model?',
      options: ['William Thomson', "Ernest Rutherford", "Ewin Schrodinger", "Democritus"],
      answer: 'William Thomson'
    },
    {
      question: 'Which bond is formed btw a metalloid and a non-metal?',
    ...
    },
    {
      ...
      "answer": "Orbital of the same energy"
    },
    {
    ...
    },
    {
      ...
      "answer": "Atoms have no internal structure"
    },
    {
      ...
      "answer": "Formulation of modern atomic theory"
    },
    {
      ...
      "answer": "The weight of their atoms"
    },
    {
    ...
    },
    {
      ...
      "answer": "Behavior in a magnetic field"
    },
    {
    ...
    },
    {
      ...
      "answer": "Failed to explain stability/nucleus position"
    },
    {
    ...
    },
    {
      ...
      "answer": "Most alpha particles deflected significantly"
    },
    {
    ...
    },
    {
      ...
      "answer": "Bohr suggests fixed orbits"
    },
    {
      ...
      "answer": "Math equations (Louis de Broglie)"
    },
    {
      ...
      "answer": "Schrödinger's electron cloud"
    },
    {
      ...
      "answer": "Failed to account for behavior in electric field"
    },
    {
    ...
    },
    {
      ...
      "answer": "Electrons embedded in it"
    },
    {
      ...
      "answer": "Empty space with a nucleus"
    },
    {
    ...
    },
    {
      ...
      "answer": "Neither forward nor reverse has stopped"
    },
    {
    ...
    },
    {
      ...
      "answer": "Higher volatility than purely covalent"
    },
    {
